#line 2 "/media/sf_Ubuntu16.04_share/compiler_cminus/build/lab1_lexical_analyzer/lex.yy.c"

#line 4 "/media/sf_Ubuntu16.04_share/compiler_cminus/build/lab1_lexical_analyzer/lex.yy.c"
...
static yyconst flex_int16_t yy_accept[65] =
    {   0,
        0,    0,   37,   35,    3,    1,    2,   35,   17,   18,
        6,    4,   16,    5,    7,   31,   15,    8,   14,   10,
       30,   30,   19,   20,   30,   30,   30,   30,   30,   21,
       22,   13,    0,   31,    9,   12,   11,   30,   30,   29,
       30,   24,   30,   30,   30,   30,    0,    0,    0,   30,
       30,   25,   30,   30,   30,   33,   23,   30,   27,   30,
       30,   28,   26,    0
    } ;
...
static yyconst YY_CHAR yy_ec[256] =
    {   0,
       ...
       18,   18,   18,   18,   18,   20,   18,   18,   21,   18,
       18,   18,   18,   18,   18,   18,   18,   18,   18,   18,
       22,    1,   23,    1,    1,    1,   18,   18,   18,   24,
...
static yyconst flex_uint16_t yy_base[68] =
    {   0,
        0,    0,   81,   82,   82,   82,   82,   64,   82,   82,
       82,   82,   82,   82,   71,   65,   82,   61,   60,   59,
        0,   53,   50,   82,   43,   14,   46,   39,   42,   82,
       82,   82,   33,   55,   82,   82,   82,    0,   47,   82,
       33,    0,   31,   30,   35,   34,   34,   35,   40,    0,
       36,    0,   25,   35,   29,   82,    0,   25,    0,   26,
       20,    0,    0,   82,   47,   52,   54
    } ;
...
static yyconst flex_int16_t yy_def[68] =
    {   0,
       ...
       65,   65,   64,   64,   65,   65,   65,   65,   65,   64,
       64,   64,   66,   64,   64,   64,   64,   65,   65,   64,
       65,   65,   65,   65,   65,   65,   66,   67,   66,   65,
...
static yyconst flex_uint16_t yy_nxt[122] =
    {   0,
       ...
       21,   23,   24,   21,   25,   21,   21,   26,   21,   21,
       21,   27,   21,   21,   21,   28,   29,   30,   31,   42,
       48,   48,   48,   43,   49,   49,   56,   48,   38,   63,
       62,   49,   47,   47,   49,   49,   61,   60,   59,   58,
       57,   55,   54,   53,   52,   51,   50,   34,   46,   45,
...
static yyconst flex_int16_t yy_chk[122] =
    {   0,
       ...
       33,   47,   48,   26,   33,   47,   48,   49,   65,   61,
       60,   49,   66,   66,   67,   67,   58,   55,   54,   53,
       51,   46,   45,   44,   43,   41,   39,   34,   29,   28,
       27,   25,   23,   22,   20,   19,   18,   16,   15,    8,
...
//#define YY_USER_ACTION printf(" '%s' ", yytext); fflush(stdout);

#line 538 "/media/sf_Ubuntu16.04_share/compiler_cminus/build/lab1_lexical_analyzer/lex.yy.c"
...
#line 761 "/media/sf_Ubuntu16.04_share/compiler_cminus/build/lab1_lexical_analyzer/lex.yy.c"
...
{pos_start = pos_end;pos_end = pos_start+strlen(yytext);return ELSE;}
	YY_BREAK
case 24:
YY_RULE_SETUP
#line 61 "lexical_analyzer.l"
{pos_start = pos_end;pos_end = pos_start+strlen(yytext);return IF;}
	YY_BREAK
case 25:
YY_RULE_SETUP
#line 62 "lexical_analyzer.l"
{//printf("int ok\n");
    pos_start = pos_end;pos_end = pos_start+strlen(yytext);return INT;}
	YY_BREAK
case 26:
YY_RULE_SETUP
#line 64 "lexical_analyzer.l"
{pos_start = pos_end;pos_end = pos_start+strlen(yytext);return RETURN;}
	YY_BREAK
case 27:
YY_RULE_SETUP
#line 65 "lexical_analyzer.l"
{pos_start = pos_end;pos_end = pos_start+strlen(yytext);return VOID;}
	YY_BREAK
case 28:
YY_RULE_SETUP
#line 66 "lexical_analyzer.l"
{pos_start = pos_end;pos_end = pos_start+strlen(yytext);return WHILE;}
	YY_BREAK
case 29:
YY_RULE_SETUP
...
{pos_start = pos_end;pos_end = pos_start+strlen(yytext);return LETTER;}
	YY_BREAK
case 33:
...
{pos_start = 1,pos_end = 1;/*return EOL;*/}
	YY_BREAK
case 35:
YY_RULE_SETUP
...
ECHO;
	YY_BREAK
#line 1023 "/media/sf_Ubuntu16.04_share/compiler_cminus/build/lab1_lexical_analyzer/lex.yy.c"
